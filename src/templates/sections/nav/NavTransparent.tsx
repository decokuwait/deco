...
export function NavTransparent({ ctx }: SectionProps) {
  ...
  return (
    <>
      ...
      >
        <Container wide className="flex h-16 items-center justify-between gap-3 transition-all group-data-[scrolled]:h-14 sm:h-20 sm:gap-4 sm:group-data-[scrolled]:h-16">
          <Brand ctx={ctx} />
