...
export function NavCentered({ ctx }: SectionProps) {
  ...
  return (
    <>
      <TopAnchor />
      <header className={cx("sticky z-50 border-b border-line bg-bg/90 backdrop-blur", CHROME_TOP)}>
        <Container className="flex items-center justify-between gap-3 py-3 lg:hidden">
          <Brand ctx={ctx} />
