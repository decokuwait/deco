        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {s.items.map((it) => (
            <article key={it.id} className="group rounded-card border border-line bg-bg p-6 transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-xl">
              <span className="mb-5 flex h-14 w-14 items-center justify-center rounded-card bg-primary/10 text-primary transition group-hover:bg-primary group-hover:text-primary-fg">
